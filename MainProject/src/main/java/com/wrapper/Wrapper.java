...
public class Wrapper extends TestBase {
			...
			public void iFrames (WebElement pSelectElementFrame, WebElement pSelectElementText) {
				driver.switchTo().frame(pSelectElementFrame);
				driver.switchTo().frame(pSelectElementText);
				pSelectElementText.click();
			}
			...
			public void waitToBePresentLeaveBalance (WebDriver driver, WebElement pSelectElement) {
				WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
				wait.until(ExpectedConditions.textToBePresentInElement(pSelectElement, "No Records Found"));
			}
			
			public void waitToBePresentEmployeeName (WebDriver driver, WebElement pSelectElement) {
				WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
				wait.until(ExpectedConditions.textToBePresentInElement(pSelectElement, "David"));
			}
			
			public void waitToBePresentApplicationStage (WebDriver driver, WebElement pSelectElement) {
				WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
				wait.until(ExpectedConditions.textToBePresentInElement(pSelectElement, "Application Stage"));
			}
			
			public void waitToBePresentReset (WebDriver driver, WebElement pSelectElement) {
				WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
				wait.until(ExpectedConditions.textToBePresentInElement(pSelectElement, "Reset Password link sent successfully"));
			}
