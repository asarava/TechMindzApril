...
public class AdminOperation extends TestBase {
    ...
    @FindBy(xpath="//button[@type=\"submit\"]")
	 ...
	 public void Search() throws InterruptedException { 
		 ...
		 username.sendKeys("annabenny123");
		 ...
		 userrole.sendKeys(Keys.ENTER);
		 Thread.sleep(5000);
		 employeename.sendKeys("anna Benny");
	 ...
	 public void AddEmployee() throws InterruptedException{
		 ...
		 middlename.sendKeys("moorkath");
		 wrapperObj.waitToBeClickable(driver,lastname);
		 lastname.sendKeys("shameel");
	 ...
	 public void Time() throws InterruptedException{
		 ...
		 timeemployeename.sendKeys("anna Benny");
